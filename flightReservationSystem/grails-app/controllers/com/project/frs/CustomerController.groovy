...
class CustomerController {
    ...
    def show() {
		...
		//def customerInstance = User.get(springSecurityService.principal.id)
	...
	def customerInfo = {
		...
		if(user.flightBooking != null) {
			redirect(action: "show", id: springSecurityService.principal.id)
		} else {
			customerInstance = User.get(springSecurityService.principal.id)
			render(action: "showCustomerInfo", model: [customerInstance: customerInstance])
		}
    }
