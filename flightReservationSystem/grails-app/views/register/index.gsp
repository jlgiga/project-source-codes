...
<g:form action='register' name='registerForm'>
	...
	<tbody>
		...
		<s2ui:textFieldRow name='contactNo' labelCode='user.contactNo.label' bean="${command}"
					         size='40' labelCodeDefault='Contact No' value="${command.contactNo}"/>
							 
		<s2ui:textFieldRow name='birthdate' labelCode='user.birthdate.label' bean="${command}"
					         size='40' labelCodeDefault='Birthdate' value="${command.birthdate}"/>
						
		<s2ui:textFieldRow name='address' labelCode='user.address.label' bean="${command}"
